<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\f\phpace\public/../application/index\view\menu\menu.html";i:1493347864;}*/ ?>
      ...
      <div class="widget-box" style="margin:0px;">
        ...
        <div class="widget-body" style="font-size:10px;  overflow:auto">
          <div class="widget-main" style="font-size:10px;overflow:auto">
            <div  class="tree" style="font-size:8px; width:100%; sScrollX:auto;sScrollY:auto">
            	<ul id="departtreeview" class="ztree" style="font-size:8px; width:100%; max-height:300px; sScrollX:auto;sScrollY:auto"></ul>
            </div>
          </div>
        </div>
      </div>
...
<button type="button" class="btn btn-primary btn-lg" data-whatever="cheng" data-toggle="modal" data-target="#myModal">
 测试
</button>
<!-- ff -->
...
(function ($){
  ...
  //鏋勫缓琛ㄦ牸
	...
	var widgetsetting = {
			...
			async: {
				enable: true,
				url:"../Index/Department/ajaxGetDepart",
	...
	function createTable(id){
		...
		$.post("<?php echo url('ajaxGetMenu'); ?>",{RoleID:1,id:id,num:100,page:1},function(data){
			ff.data = data.data;
	...
	$(document).ready(function(){
		$.fn.zTree.init($("#departtreeview"), widgetsetting);
		createTable(0);
	});
