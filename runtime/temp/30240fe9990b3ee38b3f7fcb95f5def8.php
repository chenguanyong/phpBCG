<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"E:\f\phpace\public/../application/index\view\user\index.html";i:1490942181;}*/ ?>
<div class="row" style="margin:0px;">
  ...
  <div class="panel panel-default col-xs-9" style="border:#000 0px solid; padding:2px">
    ...
    <div class="row">
      <div class="col-xs-5">
        <div class="clearfix">
          <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal" data-whatever="修改用户">修改</button> <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal" data-type='1' data-whatever="新增用户">添加</button> <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal" data-type='2' data-whatever="删除用户">删除</button> <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal" data-whatever="查看用户信息">查看</button>
        </div>
      </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button data-bb-handler="cancel" type="button" data-dismiss="modal" class="btn btn-default">关闭</button> <button data-bb-handler="confirm" id="sure_button" type="button" class="btn btn-primary">确定</button>
        </div>
      </div>
    </div>
  </div>
