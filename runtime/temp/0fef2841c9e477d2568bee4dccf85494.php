<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\f\phpace\public/../application/index\view\department\index.html";i:1492437476;}*/ ?>
<title>部门管理</title>
            ...
            .DataTable(
            {
                ...
                "columnDefs" : [
                    ...
                    },
                    {
                        ...
                        "targets" : 8,
                        "data" : null,
                        "defaultContent" : "<a href='javascript' class='btn btn-info btn-xs'><i class='fa fa-search-plus'></i> 查看</a><a href='javascript' class='btn btn-success btn-xs'><i class='fa fa-edit'></i> 修改</a><a href='javascript'  class='btn btn-danger btn-xs'><i class='fa fa-trash'></i> 删除</a>"
                    },
                    {
                        "targets": [ 7 ],
                        "visible": false,
